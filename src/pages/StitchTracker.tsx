...
import stitchTrackerIcon from '@images/icons/stitch_counter_v2.png';
            ...
            <div class="project-detail-section">
              <div class="project-header">
                ...
                <p class="text-neutral-700 leading-relaxed text-base">
                  Stitch Counter V2 is the next generation of stitch counting, building upon the original <A href={ROUTES.STITCH_COUNTER} class="text-blue-600 hover:text-blue-800 underline">Stitch Counter</A> with enhanced features and a modern user experience. It includes all the features from the original app plus the ability to add photos to your projects and a completely redesigned UI built with Jetpack Compose.
                </p>
              </div>
              ...
              <div class="project-tags">
                ...
                <div style={{ width: '100%', "margin-top": 'var(--spacing-lg)', "margin-bottom": 'var(--spacing-sm)' }}>
                  <h4>In Progress</h4>
                </div>
