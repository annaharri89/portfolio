        ...
        <div className="container">
          <div className="project-detail-content">
            <div className="project-detail-section">
              ...
              <h2 className="text-xl font-semibold text-neutral-900 mt-8 mb-3">1. Core Privacy Approach</h2>
              ...
              <h2 className="text-xl font-semibold text-neutral-900 mt-8 mb-3">2. Optional Diagnostics in Bug Reports</h2>
              <p className="text-neutral-700 leading-relaxed text-base mb-6">
              ...
              <h2 className="text-xl font-semibold text-neutral-900 mt-8 mb-3">3. What Diagnostics May Include</h2>
              <p className="text-neutral-700 leading-relaxed text-base mb-6">
              ...
              <h2 className="text-xl font-semibold text-neutral-900 mt-8 mb-3">4. How Diagnostics Are Used</h2>
              <p className="text-neutral-700 leading-relaxed text-base mb-6">
                Diagnostics sent in bug reports are used only for support and troubleshooting, including reproducing and fixing issues.
              </p>

              <h2 className="text-xl font-semibold text-neutral-900 mt-8 mb-3">5. Import / Export</h2>
              <p className="text-neutral-700 leading-relaxed text-base mb-6">
                Backup and restore features are user-initiated. The Developer does not automatically receive exported data.
              </p>

              <h2 className="text-xl font-semibold text-neutral-900 mt-8 mb-3">6. Third-Party Links</h2>
              <p className="text-neutral-700 leading-relaxed text-base mb-6">
                Optional support or donation links may open external websites governed by their own policies.
              </p>

              <h2 className="text-xl font-semibold text-neutral-900 mt-8 mb-3">7. Security</h2>
              <p className="text-neutral-700 leading-relaxed text-base mb-6">
              ...
              <h2 className="text-xl font-semibold text-neutral-900 mt-8 mb-3">8. Retention</h2>
              <p className="text-neutral-700 leading-relaxed text-base mb-6">
              ...
              <h2 className="text-xl font-semibold text-neutral-900 mt-8 mb-3">9. Children's Privacy</h2>
              <p className="text-neutral-700 leading-relaxed text-base mb-6">
                The App does not include background monitoring features intended to collect children's personal data.
              </p>

              <h2 className="text-xl font-semibold text-neutral-900 mt-8 mb-3">10. Changes</h2>
              <p className="text-neutral-700 leading-relaxed text-base mb-6">
              ...
              <h2 className="text-xl font-semibold text-neutral-900 mt-8 mb-3">11. Contact</h2>
